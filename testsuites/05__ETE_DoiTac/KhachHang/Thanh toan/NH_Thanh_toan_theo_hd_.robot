...
*** Test Cases ***    Mã KH         List products and nums             List giá mới      GGHD    Mã Combo    Khách thanh toán    TIền thu từ khách    Phương thức     Tài khoản
Thanh toan theo hd    [Tags]        CNKH
                      [Template]    Thanh toan cong no theo hoa don NH
                      CTKH004      ${list_prs_num}                    ${list_giamoi}    0        none     100000                   all                  Chuyển khoản      1234

*** Keywords ***
Thanh toan cong no theo hoa don NH
