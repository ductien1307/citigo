...
*** Variables ***
&{list_prs_num}    GHC0006=8
@{list_giamoi}    65000


*** Test Cases ***    Mã KH         List products and nums    List giá mới      GGHD    Mã Combo    Khách thanh toán    TIền thu từ khách
Thanh toan            [Tags]        CNKH
                      [Template]    Thanh toan cong no
                      CTKH008      ${list_prs_num}           ${list_giamoi}    0       none          100000                  30000
                      CTKH008      ${list_prs_num}           ${list_giamoi}    10       none          80000                  all
