...
*** Variables ***
&{dict_pr}        DNT009=11    DNT010=7.5    DNQD108=9    DNT010=3    DNS008=7
&{dict_giamoi}    DNT009=85000    DNT010=89000    DNQD108=70000.63    DNS007=112000    DNS008=55000
&{dict_gg}        DNT009=15    DNT010=0    DNQD108=10000.35    DNS007=25000    DNS008=5
&{dict_type}      DNT009=15    DNT010=0    DNQD108=null    DNS007=null    DNS008=5
@{list_pr_del}    DNS007
&{dict_pr_edit}   DNT009=3    DNT010=0    DNQD108=6.2    DNT010=0    DNS008=2

*** Test Cases ***
Tạo PN từ Phiếu DHN có thanh toán
    [Tags]    EDN1
    [Template]    dhn_06
    [Documentation]   Tạo phiếu NH lấy 1 phần hàng hóa từ phiếu DHN có thanh toán (Phiếu tạm, Đã xác nhận NCC) > check tồn kho, giá vốn, công nợ NCC, sổ quỹ
    NCC0036    ${dict_pr}    ${dict_giamoi}    ${dict_gg}    ${dict_type}    50000    300000    Phiếu tạm    ${dict_pr_edit}    160000
    NCC0037    ${dict_pr}    ${dict_giamoi}    ${dict_gg}    ${dict_type}    20    300000     Đã xác nhận NCC   ${dict_pr_edit}    120000

*** Keywords ***
dhn_06
    [Arguments]    ${input_supplier_code}    ${dict_product_num}    ${dict_newprice}    ${dict_discount}    ${dict_discount_type}    ${input_discount}    ${input_tientracc_bf}    ${input_status}    ${dict_update}     ${input_tientrancc}
    Log    tạo phiếu DHN
