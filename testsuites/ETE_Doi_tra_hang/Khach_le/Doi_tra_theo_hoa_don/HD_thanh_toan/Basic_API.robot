...
*** Variables ***
&{list_productnums_DTH}    KLCB004=3    KLDV004=7.5    KLQD003=4.5    KLSI0003=3    KLT0003=6
&{list_productnums_TH}    KLT0004=3.2
&{list_imei_dth}    KLSI0003=3
@{list_discount}    15    5000    20000    115000
@{list_discount_type}    dis    dis    change    change

*** Test Cases ***    List product trả hàng     List product đổi trả hàng    List imei           Phí trả hàng    List change         List change type         Change IMEI    Change type IMEI    GGDTH    Khách thanh toán    Khách thanh toán hóa đơn
Giam_gia              [Tags]                    DTKLA
                      [Template]                edthkl_hd_api_02
                      ${list_productnums_TH}    ${list_productnums_DTH}      ${list_imei_dth}    29              ${list_discount}    ${list_discount_type}    160000         change              20       200000              50000

*** Keywords ***
edthkl_hd_api_02
    [Arguments]    ${dic_productnums_th}    ${dic_productnums_dth}    ${list_imei_nums}    ${input_phi_th}    ${list_change}    ${list_change_type}
    ...    ${input_change_imei}    ${input_change_imei_type}    ${input_ggdth}    ${input_khtt}    ${input_khtt_hd}
    ...
    ${get_ma_hd}    Add new invoice without customer thr API    ${dic_productnums_th}    ${input_khtt_hd}
    ...
    ...    ${result_ggdth}    ${gghd_type}    ${liststring_prs_invoice_detail1}    ${get_invoice_id}
    Log    ${request_payload}
