...
Them dong              [Tags]        UETDM
                      [Template]    edtm01
                      CTKH048       ${list_productnums_TH1}    ${list_productnums_DTH01}    10              ${discount}     ${discount_type}                0           0              ${list_soluong_addrow}    ${discount_addrow}           ${discount_type_addrow}
...
edtm01
    ...
    #compute mua hàng
    ${result_tongtien_mua}    Sum values in list    ${list_result_thanhtien_dth}
