...
@{list_discount}    75000    15    5000    160000.3
@{list_discount_type}    change    dis    dis    change
@{list_discount1}    85000.5    20    80000    8000.3
@{list_discount_type1}    change    dis    change    dis
...
Tu dong               [Tags]                EDTTK1
                      [Template]            edtntk04
                      ${list_surcharge1}    ${list_product_nums_TH}    ${list_product_nums_DTH}     ${list_imei_dth}    30000           ${list_discount1}    ${list_discount_type1}    15             dis                 20       30000
