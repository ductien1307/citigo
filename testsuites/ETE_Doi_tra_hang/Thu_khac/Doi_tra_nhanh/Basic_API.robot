...
Basic                 [Tags]        EDTTKA
                      ...
                      CTKH002       ${list_surcharge1}    ${list_product_nums_TH}    ${list_product_nums_DTH}     ${list_imei_dth}    20000           ${list_discount1}    ${list_discount_type1}    150000         change              20       75000
