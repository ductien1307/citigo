...
*** Test Cases ***    Product Type       Product Discount      Discount Type        Invoice Discount    Customer    Payment in Inv1          Payment
Cap nhat Thanh toan             [Tags]                   UPC
                      [Template]              payment_cus
                      ${product_type1}          ${discount_1}         ${discount_type1}          0         KH043       50000         all

*** Keywords ***
payment_cus
    [Arguments]    ${dict_product_type}      ${dict_discount}      ${dict_discount_type}      ${input_invoice_discount}    ${input_bh_ma_kh}    ${input_payment_inv_first}      ${input_bh_khachtt}
    [Timeout]
