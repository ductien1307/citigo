...
*** Test Cases ***    Product Type       Product Discount      Discount Type        Invoice Discount    Invoice Discount Type       Customer    Payment      Debt Adjustment
Themmoi_KH      [Tags]                   AUPC
                      [Template]              a_adaptdebt_cus
                      ${product_type1}          ${discount_1}         ${discount_type1}          50000         null            KH042       50000          5400000

*** Keywords ***
a_adaptdebt_cus
    [Arguments]   ${dict_product_type}      ${dict_discount}      ${dict_discount_type}      ${input_invoice_discount}    ${input_invoice_discount_type}       ${input_bh_ma_kh}    ${input_bh_khachtt}       ${input_debt_adjustment}
    [Timeout]
