...
*** Test Cases ***    Product Type       Product Discount      Discount Type        Invoice Discount      Invoice Discount Type    Payment
UI_Nor_unit_serial       [Tags]                               AUPC
                      [Template]              aupcus
                      ${product_type1}          ${discount_1}         ${discount_type1}       20          20         40000

*** Keywords ***
aupcus
    [Arguments]    ${dict_product_type}      ${dict_discount}      ${dict_discount_type}      ${input_invoice_discount}    ${input_invoice_discount_type}       ${input_bh_khachtt}
