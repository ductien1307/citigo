...
KM HH hinh thuc gia ban theo SL mua_GOLIVE
                      ...
                      [Tags]                  AUPB2
                      [Template]              kmtd07
                      ${dict_nor2}            10                        KH022               60000         KM09

KM HH hinh thuc mua hang GG hang va tang hang
                      [Tags]                  AUPB2
                      [Template]              kmtd08
                      ${dict_nor1}            30000                    KH023                all           KM06      ${dict_promo_nor1}    #mua hang gg hang vnd
                      ${dict_nor1}            80000                   KH024                  0            KM08      ${dict_promo_nor2}    # mua hang tang hang
