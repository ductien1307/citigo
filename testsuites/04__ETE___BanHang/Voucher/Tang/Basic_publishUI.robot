...
*** Variables ***
&{dict_nor1}      PIB10016=2    PIB10017=1
&{dict_discount_nor1}      PIB10016=200000    PIB10017=400000
&{dict_discount1_nor1}      PIB10016=none    PIB10017=0
&{dict_nor2}      PIB10016=3    PIB10017=2

*** Test Cases ***    Product and num list    Product Discount                                                Invoice Discount    Customer    Payment    Voucher
Vocher Tang
                      [Tags]                  CBVT              VOT            UEB
                      [Template]              ebv01
                      ${dict_nor1}            ${dict_discount_nor1}                                               50000            KH007               0           VOUCHER003
                      ${dict_nor1}            ${dict_discount_nor1}                                               5            KH008               all           VOUCHER003
                      ${dict_nor1}            ${dict_discount_nor1}                                               50000            KH009               50000           VOUCHER003


*** Keywords ***
ebv01
    [Arguments]    ${dict_product_num}    ${dict_newprice}    ${input_invoice_discount}    ${input_bh_ma_kh}    ${input_bh_khachtt}    ${input_voucher_issue}
    [Timeout]
    ...
    #create voucher list
    ${list_voucher_code}      ${voucher_value}       ${minimum_invoicetotal}      Get voucher issue info and create new voucher code     ${input_voucher_issue}      1
    Reload page
    ...
    Wait Until Keyword Succeeds    3 times    2 s    Go to Release voucher popup
    Release Giveaway voucher Code    ${list_voucher_code}
    ...
    #${result_ktt_for_validate}       Minus      ${result_khachcantra}       ${result_khachcantra_af_apply_voucher}
