...
*** Test Cases ***
BC Tài chính
    [Documentation]     người dùng chỉ có quyền BC Tài chính
    [Tags]       PQ5
    [Template]    pnbctc1
    userbctc1    123
...
pnbctc1
    ...
    ${payload}    Format String    {{"UserId":{0},"BranchId":{1},"RoleId":{2},"Data":{{"EndOfDayReport_EndOfDayProduct":false,"Clocking_Copy":false,"EndOfDayReport_EndOfDaySynthetic":false,"EndOfDayReport_EndOfDayCashFlow":false,"EndOfDayReport_EndOfDayDocument":false,"SaleReport_SaleByUser":false,"SaleReport_SaleProfitByInvoice":false,"SaleReport_SaleDiscountByInvoice":false,"SaleReport_SaleByRefund":false,"SaleReport_SaleByTime":false,"PayslipPayment_Create":false,"PayslipPayment_Update":false,"PayslipPayment_Delete":false,"SaleReport_BranchSaleReport":false,"OrderReport_ByDocReport":false,"OrderReport_ByProductReport":false,"ProductReport_ProducStockInOutStock":false,"ProductReport_ProductByBatchExpire":false,"ProductReport_ProductByCustomer":false,"ProductReport_ProductByDamageItem":false,"ProductReport_ProductBySupplier":false,"ProductReport_ProductByUser":false,"ProductReport_ProducInOutStock":false,"ProductReport_ProducInOutStockDetail":false,"ProductReport_ProductByProfit":false,"ProductReport_ProductBySale":false,"FinancialReport_SalePerformanceReport":true,"CustomerReport_BigCustomerDebt":false,"CustomerReport_CustomerProduct":false,"CustomerReport_CustomerSale":false,"CustomerReport_CustomerProfit":false,"UserReport_ByProfitReport":false,"UserReport_ByUserReport":false,"UserReport_BySaleReport":false,"SupplierReport_SupplierInforReport":false,"SupplierReport_BigByLiabilitiesReport":false,"SupplierReport_PurchaseOrderReport":false,"SaleChannelReport_ByProduct":false,"SaleChannelReport_ByProfit":false,"SaleChannelReport_BySale":false}},"TimeAccess":[],"BranchName":"Chi nhánh trung tâm","userId":{0},"CompareGivenName":"{3}","CompareUserName":"{3}"}}    ${get_user_id}    ${BRANCH_ID}    ${get_role_id}        ${taikhoan}
    Log    ${payload}
    ...
    Wait Until Keyword Succeeds    3x    5s    Element Should Contain    ${cell_du_lieu_bc}     Báo cáo kết quả hoạt động kinh doanh
    Element Should Contain    ${cell_du_lieu_bc}      Doanh thu bán hàng
