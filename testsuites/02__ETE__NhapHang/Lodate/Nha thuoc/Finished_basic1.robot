...
*** Variables ***
&{dict_imp1}      T00001=3,2    T00002=4.2,5
&{dict_giamoi1}    T00001=85000    T00002=none
&{dict_gg1}       T00001=5000.8    T00002=10

*** Test Cases ***    Mã NCC        Mã SP - SL      Giá mới            GGSP           GGPN     Tiền trả NCC
Basic                 [Tags]        EBNT
                      [Template]    ennl3
                      NCC0003       ${dict_imp1}    ${dict_giamoi1}    ${dict_gg1}    50000    all
