...
*** Variables ***
&{dict_imp3}      LD17=12    LD18=3     QD24=9.2
&{dict_giamoi3}    LD17=85000    LD18=none      QD24=none
&{dict_gg3}       LD17=15    LD18=7000.65     QD24=10

*** Test Cases ***    Mã NCC        Mã SP - SL              Giá mới            GGSP           GGPN     Tiền trả NCC
Taomoi - draft
                      [Tags]        ENL
                      [Template]    etnl_taomoi_draft
                      NCC0014       ${dict_imp3}            ${dict_giamoi3}    ${dict_gg3}    10        all
...
etnl_taomoi_draft
    ...
    ${list_cost_bf_ex}    ${list_onhand_bf_ex}    Get list cost - onhand frm API    ${list_pr_cb}    # lap phieu
    ...
    : FOR    ${item_product}    IN ZIP    ${list_pr_cb}
    \    Wait Until Keyword Succeeds    3 times    30s    Assert values not avaiable in Stock Card    ${import_code}    ${item_product}
    #
    ...
    : FOR    ${item_pr}    ${item_cost_bf}    ${item_cost_af}    ${item_onhand_bf}    ${item_onhand_af}    IN ZIP
    ...    ${list_prs}    ${list_cost_bf_ex}    ${list_result_cost_af_ex}    ${list_onhand_bf_ex}    ${list_result_onhand_af_ex}
