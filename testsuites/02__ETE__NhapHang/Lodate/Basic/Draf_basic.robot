...
*** Variables ***
&{dict_imp2}      LD15=10.4    LD16=9     QD23=6
&{dict_giamoi2}    LD15=none    LD16=75000      QD21=68000.2
&{dict_gg2}       LD15=5000    LD16=25        QD21=3000.3

*** Test Cases ***    Mã NCC        Mã SP - SL              Giá mới            GGSP           GGPN     Tiền trả NCC
Draft
                      [Tags]        ENL
                      [Template]    etnl_draft
                      NCC0013       ${dict_imp2}            ${dict_giamoi2}    ${dict_gg2}    35000    50000
...
etnl_draft
    ...
    ${list_cost_bf_ex}    ${list_onhand_bf_ex}    Get list cost - onhand frm API    ${list_pr_cb}
    # lap phieu
