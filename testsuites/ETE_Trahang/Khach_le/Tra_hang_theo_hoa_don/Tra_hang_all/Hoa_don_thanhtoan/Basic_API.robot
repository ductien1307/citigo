...
*** Variables ***
&{list_productnums}    KLCB012=5    KLDV012=5    KLQD012=3.5    KLSI0012=3    KLT0012=6
&{list_create_imei}    KLSI0012=3
@{list_discount}    20    120000.55    1400    130000    40000
@{list_discount_type}    dis    change    dis    change    change

*** Test Cases ***    Mã KH                  List products and nums    List IMEI    Phí trả hàng    Khách thanh toán    List GGSP                GGHD     Mã HH combo
Basic                 [Tags]                 THKLA
                      [Template]             ethkl_inv_api_04
                      ${list_productnums}    ${list_create_imei}       15000        300000          ${list_discount}    ${list_discount_type}    70000
