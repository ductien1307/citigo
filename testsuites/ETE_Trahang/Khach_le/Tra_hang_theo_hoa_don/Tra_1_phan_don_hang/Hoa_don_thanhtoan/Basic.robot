...
ethkl_inv_02
    ...
    \    ${laster_number}    Wait Until Keyword Succeeds    3 times    8 s    Input nums for multi product    ${item_hh}
    \    ...    ${item_soluong}    ${laster_number}    ${cell_laster_numbers_return}
