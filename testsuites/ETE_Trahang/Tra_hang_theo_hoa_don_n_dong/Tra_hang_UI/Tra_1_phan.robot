...
Tra 1 phan            [Tags]                  THND
                      [Template]              ethnd01
                      ${invoice_1}            ${product_type1}    ${invoice_1_product_line_num}    ${discount_1}       ${discount_type1}    50000               null                     CRPKH015    50000      ${dict_edit}        20              100000
...
ethnd01
    ...
    ...    IN ZIP    ${list_products}    ${list_productid}    ${list_product_type}    ${list_product_line_num}    ${list_num_edit}
    ...    ${list_imei_actual}
