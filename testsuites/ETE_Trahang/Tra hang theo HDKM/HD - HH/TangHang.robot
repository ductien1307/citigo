...
*** Variables ***
&{invoice_1}      DV037=10       DVT0215=1         QDBTT13=3
&{discount_1}      DV037=50000       DVT0215=0
&{discount_type1}      DV037=disvnd       DVT0215=changedown   QDBTT13=0
&{invoice1_product_type}      DV037=ser      DVT0215=pro   QDBTT13=unit
&{invoice1_promo_type}      DV037=promo      DVT0215=getpromo
&{return_1}     DV037=8       DVT0215=1     QDBTT13=3
...
KM HD_HH_Tang          [Tags]             ETP
                      [Template]              ethkm3
                      ${invoice_1}            ${invoice1_product_type}      ${discount_1}         ${discount_type1}          10                        DHDPT007        0           KM014           ${invoice1_promo_type}         ${return_1}               15                2000000

*** Keywords ***
ethkm3
    [Arguments]    ${dict_product_num}    ${dict_product_type}    ${dict_discount}    ${dict_discount_type}    ${input_invoice_discount}
    ...    ${input_bh_ma_kh}    ${input_bh_khachtt}    ${input_khuyemmai}    ${dict_promo_product}      ${dict_return}    ${input_phi_th}    ${input_tien_tra_khach}
    ${get_ma_hd}    Add new invoice incase promotion invoice and product - offering free items    ${dict_product_num}    ${dict_product_type}    ${dict_discount}    ${dict_discount_type}    ${input_invoice_discount}
